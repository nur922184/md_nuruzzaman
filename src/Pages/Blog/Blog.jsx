        ...
        <div className="min-h-screen bg-gradient-to-r from-[#BBD2C5] via-[#536976] to-[#536976] text-teal-900">
            ...
            <div className="md:pt-20">
                ...
                <section className="max-w-6xl mx-auto px-4 py-12 text-center">
                    ...
                    <form className="flex justify-center items-center space-x-1">
                        ...
                        <button
                            ...
                            className=" btn btn-sm text-xs  bg-teal-300 text-black font-medium rounded-md hover:bg-teal-400 focus:outline-none focus:ring-2 focus:ring-red-500"
                        >
